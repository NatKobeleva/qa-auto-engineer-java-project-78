...
[![hexlet-check](https://github.com/NatKobeleva/qa-auto-engineer-java-project-78/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/NatKobeleva/qa-auto-engineer-java-project-78/actions)
...
```bash
git clone https://github.com/NatKobeleva/qa-auto-engineer-java-project-78.git
cd qa-auto-engineer-java-project-78
```
